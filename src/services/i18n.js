...
const DICT = {
  nl: {
    ...
    'aaud.mb_title': 'Ben jij dit in MusicBrainz?',
    'aaud.mb_hint': 'MusicBrainz is het open register waar muziekdiensten je aan herkennen. Zoek jezelf op en kies je eigen pagina — dan weten anderen dat jouw muziek van jou is.',
    'aaud.mb_search': 'Zoeken',
    'aaud.mb_none': 'Niets gevonden. Sta je er nog niet in? Dan kun je jezelf aanmelden op musicbrainz.org — dat kan alleen daar, niet vanuit Klonkt.',
    'aaud.mb_pick': 'Dit ben ik',
    'aaud.mb_linked': 'Gekoppeld aan',
    'aaud.mb_unlink': 'Ontkoppelen',
    'aaud.mb_open': 'Bekijk op MusicBrainz',
    'aaud.mb_busy': 'Zoeken…',
    'aaud.mb_fail': 'MusicBrainz is even niet bereikbaar.',
  ...
  en: {
    ...
    'aaud.mb_title': 'Is this you on MusicBrainz?',
    'aaud.mb_hint': 'MusicBrainz is the open register music services recognise you by. Look yourself up and pick your own page — then others know your music is yours.',
    'aaud.mb_search': 'Search',
    'aaud.mb_none': 'Nothing found. Not in there yet? You can add yourself on musicbrainz.org — that can only be done there, not from Klonkt.',
    'aaud.mb_pick': 'This is me',
    'aaud.mb_linked': 'Linked to',
    'aaud.mb_unlink': 'Unlink',
    'aaud.mb_open': 'View on MusicBrainz',
    'aaud.mb_busy': 'Searching…',
    'aaud.mb_fail': 'MusicBrainz is unreachable right now.',
  ...
  de: {
    ...
    'aaud.mb_title': 'Bist das du bei MusicBrainz?',
    'aaud.mb_hint': 'MusicBrainz ist das offene Register, an dem Musikdienste dich erkennen. Suche dich und wähle deine eigene Seite — dann wissen andere, dass deine Musik von dir ist.',
    'aaud.mb_search': 'Suchen',
    'aaud.mb_none': 'Nichts gefunden. Noch nicht dabei? Du kannst dich auf musicbrainz.org eintragen — das geht nur dort, nicht aus Klonkt heraus.',
    'aaud.mb_pick': 'Das bin ich',
    'aaud.mb_linked': 'Verknüpft mit',
    'aaud.mb_unlink': 'Trennen',
    'aaud.mb_open': 'Bei MusicBrainz ansehen',
    'aaud.mb_busy': 'Suche läuft…',
    'aaud.mb_fail': 'MusicBrainz ist gerade nicht erreichbar.',
