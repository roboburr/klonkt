...
const DICT = {
  nl: {
    ...
    'asite.comment_moderation': 'Reactie-moderatie',
    'asite.moderation_trust': 'Vertrouwen (automatisch goedkeuren)',
  ...
  en: {
    ...
    'asite.comment_moderation': 'Comment moderation',
    'asite.moderation_trust': 'Trust (approve automatically)',
    ...
    'ahelp.s_tenancy_b': 'Admin → <strong>Settings</strong>: <em>Solo</em> = one site (you). <em>Circle</em> = your solo site plus federation with other Klonkt sites (see Circles). Hub mode has been removed.',
    'ahelp.s_fedi_h': 'Fediverse (ActivityPub)',
    'ahelp.s_fedi_b': 'Your posts appear on the fediverse automatically: people on Mastodon (or another Klonkt) can <strong>follow, like, boost and reply</strong> — you see those under a post in "From the fediverse". From Admin → <strong>Timeline</strong> you follow accounts and read their posts; <strong>Notifications</strong> and <strong>Blocking</strong> live there too. The ⭐ on a post lets visitors like it from their own fediverse account. There is also a "Follow via the fediverse" button on your <strong>profile</strong> so visitors can follow you from their own account.',
    'ahelp.s_premium_h': 'Premium / Patreon',
  ...
  de: {
    ...
    'aset.fediverse_toggle': 'Fediverse an (Folgen, Liken, Kommentieren)', 'aset.mode': 'Modus', 'aset.mode_help': 'Wähle, wie deine Site funktioniert.', 'aset.mode_solo': 'Solo', 'aset.mode_solo_help': 'Ein eigenständiger Blog — kein Fediverse, keine Kommentare. Ruhig und in sich geschlossen.', 'aset.mode_cirkels': 'Kreise', 'aset.mode_cirkels_help': 'Mach beim Fediverse mit (ActivityPub): Leute auf Mastodon oder einem anderen Klonkt können dir folgen, liken und antworten, und du kannst einem Kreis von Sites folgen.',
    'aset.email_smtp': 'E-Mail (SMTP)',
    ...
    'asite.comment_moderation': 'Kommentar-Moderation',
    'asite.moderation_trust': 'Vertrauen (automatisch freigeben)',
    ...
    'ahelp.s_tenancy_b': 'Verwaltung → <strong>Einstellungen</strong>: <em>Solo</em> = eine Seite (du). <em>Zirkel</em> = deine Solo-Seite plus Föderation mit anderen Klonkt-Seiten (siehe Zirkel). Der Hub-Modus wurde entfernt.',
    'ahelp.s_fedi_h': 'Fediverse (ActivityPub)',
    'ahelp.s_fedi_b': 'Deine Beiträge erscheinen automatisch im Fediverse: Leute auf Mastodon (oder einem anderen Klonkt) können dir <strong>folgen, liken, teilen und antworten</strong> — das siehst du unter einem Beitrag bei "Aus dem Fediverse". Über Verwaltung → <strong>Timeline</strong> folgst du Konten und liest ihre Beiträge; <strong>Benachrichtigungen</strong> und <strong>Blockieren</strong> sind dort auch. Mit dem ⭐ an einem Beitrag liken Besucher ihn von ihrem eigenen Fediverse-Konto. Auf deinem <strong>Profil</strong> gibt es außerdem einen "Über das Fediverse folgen"-Button, mit dem Besucher dir von ihrem eigenen Konto folgen.',
    'ahelp.s_premium_h': 'Premium / Patreon',
