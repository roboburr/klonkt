...
const DICT = {
  nl: {
    ...
    'pedit.publish_at_label': 'Publiceren op (laat leeg = direct)',
  ...
  en: {
    ...
    'pedit.publish_at_label': 'Publish at (leave empty = immediately)',
  ...
  de: {
    ...
    'pedit.publish_at_label': 'Veröffentlichen am (leer lassen = sofort)',
