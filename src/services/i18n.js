...
const DICT = {
  nl: {
    ...
    'ahelp.s_premium_b': 'Premium-functies (Statistieken, Agenda, Downloads, Perskit, Nieuwsbrief, Link-in-bio, Embed) ontgrendel je in Beheer → Instellingen door Patreon te koppelen ($10 lifetime). Updates en de kernapp blijven altijd gratis.',
  ...
  en: {
    ...
    'ahelp.s_premium_h': 'Premium / Patreon',
    'ahelp.s_premium_b': 'You unlock premium features (Statistics, Agenda, Downloads, Press kit, Newsletter, Link-in-bio, Embed) in Admin → Settings by connecting Patreon ($10 lifetime). Updates and the core app always stay free.',
  ...
  de: {
    ...
    'ahelp.s_premium_h': 'Premium / Patreon',
    'ahelp.s_premium_b': 'Premium-Funktionen (Statistiken, Termine, Downloads, Pressekit, Newsletter, Link-in-Bio, Embed) schaltest du in Verwaltung → Einstellungen frei, indem du Patreon verknüpfst ($10 lebenslang). Updates und die Kern-App bleiben immer kostenlos.',
