...
const DICT = {
  nl: {
    ...
    'aset.premium_lifetime': '$10-lifetime',
    ...
    'aset.patreon_no_lifetime': 'Patreon gekoppeld, maar nog geen $10 lifetime',
    'aset.now': 'nu',
    ...
    'ahelp.s_tenancy_h': 'Solo- / Hub-modus',
    'ahelp.s_tenancy_b': 'Beheer → <strong>Instellingen</strong>: <em>Solo</em> = één site (jij). <em>Hub</em> = een bedrijfs-/labelsite met meerdere makers, elk een eigen Klonkt onder <code>/user/&lt;naam&gt;</code>. <em>Cirkel</em> = solo + federatie met andere sites.',
    'ahelp.s_premium_h': 'Premium / Patreon',
    'ahelp.s_premium_b': 'Premium-functies (Hub, Statistieken, Agenda, Downloads, Perskit, Nieuwsbrief, Link-in-bio, Embed, fan-login) ontgrendel je in Beheer → Instellingen door Patreon te koppelen ($10 lifetime). Updates en de kernapp blijven altijd gratis.',
  ...
  en: {
    ...
    'aset.patreon_no_lifetime': 'Patreon connected, but no $10 lifetime yet',
    'aset.now': 'now',
    ...
    'ahelp.s_tenancy_h': 'Solo / Hub mode',
    'ahelp.s_tenancy_b': 'Admin → <strong>Settings</strong>: <em>Solo</em> = one site (you). <em>Hub</em> = a company/label site with multiple creators, each with their own Klonkt under <code>/user/&lt;name&gt;</code>. <em>Circle</em> = solo + federation with other sites.',
    'ahelp.s_premium_h': 'Premium / Patreon',
    'ahelp.s_premium_b': 'You unlock premium features (Hub, Statistics, Agenda, Downloads, Press kit, Newsletter, Link-in-bio, Embed, fan login) in Admin → Settings by connecting Patreon ($10 lifetime). Updates and the core app always stay free.',
  ...
  de: {
    ...
    'aset.patreon_no_lifetime': 'Patreon verbunden, aber noch keine $10 Lifetime',
    'aset.now': 'derzeit',
    ...
    'ahelp.s_tenancy_h': 'Solo- / Hub-Modus',
    'ahelp.s_tenancy_b': 'Verwaltung → <strong>Einstellungen</strong>: <em>Solo</em> = eine Seite (du). <em>Hub</em> = eine Firmen-/Label-Seite mit mehreren Kreativen, jeweils mit eigenem Klonkt unter <code>/user/&lt;Name&gt;</code>. <em>Zirkel</em> = Solo + Föderation mit anderen Seiten.',
    'ahelp.s_premium_h': 'Premium / Patreon',
    'ahelp.s_premium_b': 'Premium-Funktionen (Hub, Statistiken, Termine, Downloads, Pressekit, Newsletter, Link-in-Bio, Embed, Fan-Login) schaltest du in Verwaltung → Einstellungen frei, indem du Patreon verknüpfst ($10 lebenslang). Updates und die Kern-App bleiben immer kostenlos.',
