...
const DICT = {
  nl: {
    ...
    'asite.mb_title': 'Ben jij dit in MusicBrainz?',
    'asite.mb_hint': 'MusicBrainz is het open register waar muziekdiensten je aan herkennen. Zoek jezelf op en kies je eigen pagina — dan weten anderen dat jouw muziek van jou is.',
    'asite.mb_search': 'Zoeken',
    'asite.mb_placeholder': 'Je artiestennaam',
    'asite.mb_none': 'Niets gevonden. Sta je er nog niet in? Dan kun je jezelf aanmelden op musicbrainz.org — dat kan alleen daar, niet vanuit Klonkt.',
    'asite.mb_pick': 'Dit ben ik',
    'asite.mb_linked': 'Gekoppeld aan',
    'asite.mb_unlink': 'Ontkoppelen',
    'asite.mb_open': 'Bekijk op MusicBrainz',
    'asite.mb_busy': 'Zoeken…',
    'asite.mb_fail': 'MusicBrainz is even niet bereikbaar.',
  ...
  en: {
    ...
    'asite.mb_title': 'Is this you on MusicBrainz?',
    'asite.mb_hint': 'MusicBrainz is the open register music services recognise you by. Look yourself up and pick your own page — then others know your music is yours.',
    'asite.mb_search': 'Search',
    'asite.mb_placeholder': 'Your artist name',
    'asite.mb_none': 'Nothing found. Not in there yet? You can add yourself on musicbrainz.org — that can only be done there, not from Klonkt.',
    'asite.mb_pick': 'This is me',
    'asite.mb_linked': 'Linked to',
    'asite.mb_unlink': 'Unlink',
    'asite.mb_open': 'View on MusicBrainz',
    'asite.mb_busy': 'Searching…',
    'asite.mb_fail': 'MusicBrainz is unreachable right now.',
  ...
  de: {
    ...
    'asite.mb_title': 'Bist das du bei MusicBrainz?',
    'asite.mb_hint': 'MusicBrainz ist das offene Register, an dem Musikdienste dich erkennen. Suche dich und wähle deine eigene Seite — dann wissen andere, dass deine Musik von dir ist.',
    'asite.mb_search': 'Suchen',
    'asite.mb_placeholder': 'Dein Künstlername',
    'asite.mb_none': 'Nichts gefunden. Noch nicht dabei? Du kannst dich auf musicbrainz.org eintragen — das geht nur dort, nicht aus Klonkt heraus.',
    'asite.mb_pick': 'Das bin ich',
    'asite.mb_linked': 'Verknüpft mit',
    'asite.mb_unlink': 'Trennen',
    'asite.mb_open': 'Bei MusicBrainz ansehen',
    'asite.mb_busy': 'Suche läuft…',
    'asite.mb_fail': 'MusicBrainz ist gerade nicht erreichbar.',
