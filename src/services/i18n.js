...
const DICT = {
  nl: {
    ...
    'fedi.remote_title': 'Reageer via de fediverse', 'fedi.follow_heading': 'Volgen via de fediverse', 'fedi.follow_intro': 'Je staat op het punt te volgen:', 'fedi.follow_btn': 'Volgen', 'fedi.followed_title': 'Volgverzoek verstuurd ✅', 'fedi.followed_done': 'Je volgverzoek is onderweg. Zodra de andere kant het accepteert, verschijnen hun berichten in je tijdlijn.', 'fedi.view_profile': 'Bekijk profiel →', 'fedi.remote_reply': 'Reageer via de fediverse', 'fedi.remote_prompt': 'Je fediverse-adres (bv. @jij@mastodon.social):', 'fedi.remote_notfound': 'Kon die post niet ophalen. Plak de volledige post-URL:', 'fedi.remote_load': 'Ophalen', 'fedi.remote_replying_to': 'Je reageert op', 'fedi.remote_as': 'Wordt verzonden als {site}.', 'fedi.remote_view_original': 'Bekijk de hele post + reacties op de bron →', 'fedi.remote_reply_short': 'via de fediverse', 'fedi.remote_ph': 'jouw server', 'fedi.remote_sent_title': 'Verzonden ✅', 'fedi.remote_sent': 'Je reactie is onderweg naar de fediverse en verschijnt zo bij de ontvanger.', 'fedi.remote_back': '← Terug naar je site', 'fedi.like_btn': 'Like deze post', 'fedi.or_reply': 'of reageer:', 'fedi.liked_title': 'Geliket', 'fedi.liked_done': 'Je like is onderweg naar de fediverse.', 'fedi.delete_confirm': 'Deze reactie verwijderen?', 'fedi.manage_title': 'Mijn fediverse-reacties', 'fedi.manage_empty': 'Je hebt nog geen reacties verstuurd.', 'tl.title': 'Tijdlijn', 'tl.lead': 'Volg accounts in de fediverse en zie hun berichten hier.', 'tl.follow_btn': 'Volgen', 'tl.following': 'Je volgt', 'tl.unfollow': 'Ontvolgen', 'tl.pending': 'in afwachting', 'tl.feed': 'Berichten', 'tl.empty': 'Nog niks — volg iemand om hun berichten hier te zien.', 'tl.view_original': 'Bekijk origineel →',
    ...
    'ahelp.s_newpost_b': 'Beheer → <strong>Nieuwe post</strong>. Geef een titel en schrijf je inhoud. Onderaan kies je de status: <em>concept</em> (niet zichtbaar) of <em>gepubliceerd</em>. Concepten staan bovenaan in je Beheer-overzicht zodat je ze terugvindt.',
    ...
    'pedit.foto_up_hint': 'Zet je foto als cover hierboven, of voeg foto’s toe in de tekst met de afbeelding-knop in de werkbalk.',
  ...
  en: {
    ...
    'ahelp.s_newpost_b': 'Admin → <strong>New post</strong>. Give it a title and write your content. At the bottom you choose the status: <em>draft</em> (not visible) or <em>published</em>. Drafts appear at the top of your Admin overview so you can find them again.',
    ...
    'pedit.foto_up_hint': 'Set your photo as the cover above, or add photos in the text with the image button in the toolbar.',
  ...
  de: {
    ...
    'ahelp.s_newpost_b': 'Verwaltung → <strong>Neuer Beitrag</strong>. Gib einen Titel ein und schreibe deinen Inhalt. Unten wählst du den Status: <em>Entwurf</em> (nicht sichtbar) oder <em>veröffentlicht</em>. Entwürfe stehen oben in deiner Verwaltungsübersicht, damit du sie wiederfindest.',
    ...
    'pedit.foto_up_hint': 'Lege dein Foto oben als Titelbild fest oder füge Fotos im Text über die Bild-Schaltfläche in der Symbolleiste ein.',
