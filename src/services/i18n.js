...
const DICT = {
  nl: {
    ...
    'aseo.mb_legend': 'MusicBrainz (dezelfde artiest elders)',
    'aseo.mb_search_label': 'Zoek jezelf op',
    'aseo.mb_search_hint': 'de naam waaronder je muziek uitbrengt',
    'aseo.mb_hint': 'MusicBrainz is het open register van de muziekwereld. Koppel je eigen pagina en je komt als sameAs in de JSON-LD van deze site én in je fediverse-profiel te staan — zo weten zoekmachines en muziekdiensten dat jouw muziek van jou is. Je verandert er niets mee bij MusicBrainz zelf; we verwijzen er alleen naar.',
    'aseo.mb_search': 'Zoeken',
    'aseo.mb_placeholder': 'Je artiestennaam',
  ...
  en: {
    ...
    'aseo.mb_legend': 'MusicBrainz (the same artist elsewhere)',
    'aseo.mb_search_label': 'Look yourself up',
    'aseo.mb_search_hint': 'the name you release music under',
    'aseo.mb_hint': 'MusicBrainz is the music world\u2019s open register. Link your own page and it appears as sameAs in this site\u2019s JSON-LD and in your fediverse profile — so search engines and music services know your music is yours. It changes nothing at MusicBrainz itself; we only point at it.',
    'aseo.mb_search': 'Search',
    'aseo.mb_placeholder': 'Your artist name',
  ...
  de: {
    ...
    'aseo.mb_legend': 'MusicBrainz (dieselbe Künstlerin anderswo)',
    'aseo.mb_search_label': 'Dich selbst suchen',
    'aseo.mb_search_hint': 'der Name, unter dem du Musik veröffentlichst',
    'aseo.mb_hint': 'MusicBrainz ist das offene Register der Musikwelt. Verknüpfe deine Seite, und sie erscheint als sameAs im JSON-LD dieser Website und in deinem Fediverse-Profil — so wissen Suchmaschinen und Musikdienste, dass deine Musik von dir ist. Bei MusicBrainz selbst ändert sich nichts; wir verweisen nur darauf.',
    'aseo.mb_search': 'Suchen',
    'aseo.mb_placeholder': 'Dein Künstlername',
