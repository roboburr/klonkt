/**
 * PlatformIcons — curated list of social/streaming platforms for the
 * profile-header social links. Mirrors v9's pcms_profile_platforms() but
 * with inline SVG so we don't need an icons.svg sprite.
 *
 * Each entry: { key, label, brand, host, svg } where:
 *   - key   : stable id used in DB (sites.profile_links[].platform)
 *   - label : human readable name
 *   - brand : hex color for hover/icon background
 *   - host  : domain hint (used to autodetect from URL if user pastes one)
 *   - svg   : inline path data (single <svg> ready)
 */
...
export const PLATFORMS = {
  ...
  bandcamp: {
    ...
    brand: '#629AA9',
    host: 'bandcamp.com',
    svg: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M0 18.75l7.437-13.5H24l-7.438 13.5H0z"/></svg>',
  },
  soundcloud: {
    label: 'SoundCloud',
    brand: '#FF5500',
